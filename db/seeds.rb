...
Title.create!(
  [
    { name: 'slogan', title: 'На сайте используются', language: 'ru', page: 'main' },
    { name: 'slogan', title: "Promptly\nProperly\nAlways in touch", language: 'en', page: 'main' },
    { name: 'slogan', title: "高质量的产品\n定时交货\n随时保持联系", language: 'zh', page: 'main' },
    { name: 'coal_supplied', title: 'Поставлено угля', language: 'ru', page: 'main' },
    { name: 'coal_supplied', title: 'Tons of coal delivered', language: 'en', page: 'main' },
    { name: 'coal_supplied', title: '已交付煤炭', language: 'zh', page: 'main' },
    { name: 'about_company', title: 'О компании', language: 'ru', page: 'main' },
    { name: 'about_company', title: 'ABOUT US', language: 'en', page: 'main' },
    { name: 'about_company', title: '关于集团', language: 'zh', page: 'main' },
    { name: 'coal_sales', title: 'Продажа угля', language: 'ru', page: 'main' },
    { name: 'coal_sales', title: 'Thermal coal', language: 'en', page: 'main' },
    { name: 'coal_sales', title: '煤炭销售', language: 'zh', page: 'main' },
    { name: 'supply_basic', title: 'Базис доставки', language: 'ru', page: 'main' },
    { name: 'supply_basic', title: 'Delivery bases', language: 'en', page: 'main' },
    { name: 'supply_basic', title: '供货基础', language: 'zh', page: 'main' },
    { name: 'news', title: 'Новости', language: 'ru', page: 'main' },
    { name: 'news', title: 'News', language: 'en', page: 'main' },
    { name: 'news', title: '消息', language: 'zh', page: 'main' },

    { name: 'write_us', title: 'Напишите нам', language: 'ru', page: 'main' },
    { name: 'write_us', title: 'Write to us', language: 'en', page: 'main' },
    { name: 'write_us', title: '给我们写信', language: 'zh', page: 'main' },
    { name: 'you_name', title: 'Ваше имя', language: 'ru', page: 'main' },
    { name: 'you_name', title: 'Your name', language: 'en', page: 'main' },
    { name: 'you_name', title: '您的姓名', language: 'zh', page: 'main' },
    { name: 'you_name_hint', title: 'Как вас зовут?', language: 'ru', page: 'main' },
    { name: 'you_name_hint', title: 'What is your name?', language: 'en', page: 'main' },
    { name: 'you_name_hint', title: '您叫什么名字？', language: 'zh', page: 'main' },
    { name: 'email', title: 'E-mail для обратной связи', language: 'ru', page: 'main' },
    { name: 'email', title: 'Email for feedback', language: 'en', page: 'main' },
    { name: 'email', title: 'E-mail', language: 'zh', page: 'main' },
    { name: 'email_hint', title: 'Почта', language: 'ru', page: 'main' },
    { name: 'email_hint', title: 'Email', language: 'en', page: 'main' },
    { name: 'email_hint', title: 'E-mail', language: 'zh', page: 'main' },
    { name: 'phone', title: 'Ваш контактный телефон', language: 'ru' },
    { name: 'phone', title: 'Your contact phone number', language: 'en', page: 'main' },
    { name: 'phone', title: '您的聯絡電話', language: 'zh', page: 'main' },
    { name: 'phone_hint', title: '+7 999 999 99 99', language: 'ru', page: 'main' },
    { name: 'phone_hint', title: '+7 999 999 99 99', language: 'en', page: 'main' },
    { name: 'phone_hint', title: '+7 999 999 99 99', language: 'zh', page: 'main' },
    { name: 'org', title: 'Наименование организации', language: 'ru', page: 'main' },
    { name: 'org', title: 'Name of company', language: 'en', page: 'main' },
    { name: 'org', title: '公司名稱', language: 'zh', page: 'main' },
    { name: 'dream', title: 'Желаемая цена (с указанием валюты за тонну)', language: 'ru', page: 'main' },
    { name: 'dream', title: 'Desired price (indicating currency per ton)', language: 'en', page: 'main' },
    { name: 'dream', title: '期望價格（表示貨幣每噸）', language: 'zh', page: 'main' },
    { name: 'org_hint', title: 'Название вашей организации', language: 'ru', page: 'main' },
    { name: 'org_hint', title: 'Name of your organization', language: 'en', page: 'main' },
    { name: 'org_hint', title: '您的組織名稱', language: 'zh', page: 'main' },
    { name: 'info', title: 'Дополнительная информация', language: 'ru', page: 'main' },
    { name: 'info', title: 'Additional Information', language: 'en', page: 'main' },
    { name: 'info', title: '更多信息', language: 'zh', page: 'main' },
    { name: 'info_hint', title: 'Ваше обращение', language: 'ru', page: 'main' },
    { name: 'info_hint', title: 'Your message', language: 'en', page: 'main' },
    { name: 'info_hint', title: '您的申请', language: 'zh', page: 'main' },
    { name: 'required', title: 'Это поле обязательно для заполнения', language: 'ru', page: 'main' },
    { name: 'required', title: 'This field is required', language: 'en', page: 'main' },
    { name: 'required', title: '此欄位是必需的', language: 'zh', page: 'main' },
    { name: 'supply', title: 'Поставка', language: 'ru', page: 'main' },
    { name: 'supply', title: 'Supply', language: 'en', page: 'main' },
    { name: 'supply', title: '供應', language: 'zh', page: 'main' },
    { name: 'contact_info', title: 'Контактная информация', language: 'ru', page: 'main' },
    { name: 'contact_info', title: 'Contact Information', language: 'en', page: 'main' },
    { name: 'contact_info', title: '聯絡資訊', language: 'zh', page: 'main' },
    { name: 'success', title: 'Успешно отправлено!', language: 'ru', page: 'main' },
    { name: 'success', title: 'Successfully sent!', language: 'en', page: 'main' },
    { name: 'success', title: '發送成功！', language: 'zh', page: 'main' },
    { name: 'success_desc', title: 'Ваше сообщение было доставлено, в скоре мы свяжемся с Вами.', language: 'ru', page: 'main' },
    { name: 'success_desc', title: 'Your message has been delivered, we will contact you shortly.', language: 'en', page: 'main' },
    { name: 'success_desc', title: '您的留言已送達，我們將盡快與您聯絡。', language: 'zh', page: 'main' },
    { name: 'copy', title: "Все права защищены\n© 2012-2023 SIBSTAR GROUP", language: 'ru', page: 'main' },
    { name: 'copy', title: "All rights reserved\n© 2012-2023 SIBSTAR GROUP", language: 'en', page: 'main' },
    { name: 'copy', title: "版权所有\n© 2012-2023 SIBSTAR GROUP", language: 'zh', page: 'main' },
    { name: 'policy', title: 'Политика конфиденциальности', language: 'ru', page: 'main' },
    { name: 'policy', title: 'Privacy Policy', language: 'en', page: 'main' },
    { name: 'policy', title: '隐私政策', language: 'zh', page: 'main' },
    { name: 'made', title: 'Сделано в', language: 'ru', page: 'main' },
    { name: 'made', title: 'Made by', language: 'en', page: 'main' },
    { name: 'made', title: '在完成', language: 'zh', page: 'main' },
    { name: 'coal_count_el', title: 'тонн', language: 'ru', page: 'main' },
    { name: 'coal_count_el', title: 'tons', language: 'en', page: 'main' },
    { name: 'coal_count_el', title: '噸', language: 'zh', page: 'main' },

    { name: 'sales_desc', title: 'Продажа нефтепродуктов', language: 'ru', page: 'sales' },
    { name: 'sales_desc', title: 'Sale of petroleum products', language: 'en', page: 'sales' },
    { name: 'sales_desc', title: '石油产品销售', language: 'zh', page: 'sales' },
    { name: 'sales_title', title: 'Надежность', language: 'ru', page: 'sales' },
    { name: 'sales_title', title: 'Reliability', language: 'en', page: 'sales' },
    { name: 'sales_title', title: '可靠性', language: 'zh', page: 'sales' },
    { name: 'sales_title_d', title: "Группа компаний «СИБСТАР» поставляет энергетические ресурсы по всему миру.\nБлагодаря нашим надежным партнерским отношениям и разветвленной логистической сети мы можем гарантировать\nсвоевременную и безопасную доставку нашей продукции, куда бы вы ее ни заказали.", language: 'ru', page: 'sales' },
    { name: 'sales_title_d', title: 'SIBSTAR Group supplies energy resources all over the world. Thanks to our reliable partnerships and extensive logistics network, we guarantee on-time and safe delivery of our products anywhere in the world.', language: 'en', page: 'sales' },
    { name: 'sales_title_d', title: 'SIBSTAR集团向世界各地供应能源煤炭。由于与合伙单位建立的可靠关系和发达物流网络，我集团保证及时安全送货至任何地方。', language: 'zh', page: 'sales' },

    { name: 'about_desc', title: "За все время своей деятельности мы поставили более 1 000 000 тонн угля.", language: 'ru', page: 'about' },
    { name: 'about_desc', title: 'Over the entire period of our activity, we have supplied more than 1 000 000 tons of coal.', language: 'en', page: 'about' },
    { name: 'about_desc', title: '集团建立以来总计供应了百万吨煤炭。', language: 'zh', page: 'about' },
    { name: 'mission', title: "Наша миссия", language: 'ru', page: 'about' },
    { name: 'mission', title: 'Our mission', language: 'en', page: 'about' },
    { name: 'mission', title: '我们的使命', language: 'zh', page: 'about' },

    { name: 'quality', title: "Качественно", language: 'ru', page: 'about' },
    { name: 'quality', title: 'Quality', language: 'en', page: 'about' },
    { name: 'quality', title: '高质量的产品', language: 'zh', page: 'about' },

    { name: 'fast', title: "Оперативно", language: 'ru', page: 'about' },
    { name: 'fast', title: 'Fast', language: 'en', page: 'about' },
    { name: 'fast', title: '高质量的产品', language: 'zh', page: 'about' },

    { name: 'in_touch', title: "Всегда на связи", language: 'ru', page: 'about' },
    { name: 'in_touch', title: 'Always in touch', language: 'en', page: 'about' },
    { name: 'in_touch', title: '随时保持联系', language: 'zh', page: 'about' },

    { name: 'advantages', title: "Преимущества", language: 'ru', page: 'about' },
    { name: 'advantages', title: 'Advantages', language: 'en', page: 'about' },
    { name: 'advantages', title: '优势', language: 'zh', page: 'about' },

    { name: 'command_title', title: "Команда SibstarGroup", language: 'ru', page: 'about' },
    { name: 'command_title', title: 'SibstarGroup team', language: 'en', page: 'about' },
    { name: 'command_title', title: 'SibstarGroup团队', language: 'zh', page: 'about' },

    { name: 'advantages_desc', title: "Благодаря выгодному расположению и совершенной логистики с российских угольных\n разрезов на Кузбассе, в Сибири и на Дальнем Востоке, мы обеспечиваем удобный доступ к международным рынкам.\n Отгрузки энергоносителей осуществляются в адрес производственных гигантов. Наши ключевые партнеры — крупные промышленные предприятия Китая, Индии и Турции.", language: 'ru', page: 'about' },
    { name: 'advantages_desc', title: "Thanks to the advantageous location and perfect logistics from Russian coal mines in Kuzbass, Siberia and the Far East, we provide convenient access to international markets.\n Energy shipments are carried out to the largest manufacturing giants. Our key partners are large industrial enterprises of China, India and Türkiye.", language: 'en', page: 'about' },
    { name: 'advantages_desc', title: "由于俄罗斯库兹巴斯、西伯利亚、远东地区煤矿的有利位置和完善物流，我集团提供进入中国市场和国际市场的便利通道。\n SIBSTAR集团为东南亚的大型制造公司提供能源煤炭。集团的主要合作伙伴是中国、印度和土耳其的大型工业企业。", language: 'zh', page: 'about' },

    { name: 'about_text', title: "Основным направлением деятельности группы компаний «СИБСТАР» является поставка\n высококачественного каменного и коксующегося угля с угледобывающих предприятий Российской Федерации.", language: 'ru', page: 'about' },
    { name: 'about_text', title: 'SIBSTAR Group offers a wide range of high-quality energy and metallurgical products based in Russian Federation.', language: 'en', page: 'about' },
    { name: 'about_text', title: 'SIBSTAR集团主要业务是供应来自俄罗斯的优质石煤和焦煤。', language: 'zh', page: 'about' },

    { name: 'mission_desc', title: "Мы целенаправлены на поддержку мировой промышленности путем обеспечения\n стабильных поставок высококачественной продукции. Стремимся к долгосрочным и взаимовыгодным отношениям с\n нашими клиентами и партнерами, предоставляя наилучший сервис и оптимальные решения.", language: 'ru', page: 'about' },
    { name: 'mission_desc', title: 'We are focused on supporting the global industry by ensuring stable supplies of high-quality products. We strive for long-term and mutually beneficial relationships with our clients and partners, providing the best service and optimal solutions.', language: 'en', page: 'about' },
    { name: 'mission_desc', title: '我们致力于通过确保稳定供应高质量产品来支持全球工业。我们追求与客户和合作伙伴建立长期而互惠互利的关系，提供最佳服务和最优解决方案。', language: 'zh', page: 'about' }
  ]
)
